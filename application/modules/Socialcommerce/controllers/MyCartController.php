...
class Socialcommerce_MyCartController extends Core_Controller_Action_Standard
{
    ...
    public function indexAction()
    {
        ...
        return $this->_forward('success', 'utility', 'core', array(
            ...
            'messages' => array(Zend_Registry::get('Zend_Translate')->_('Your cart has been successfully updated.'))
        ));
    }
    ...
    protected function _updateCart()
    {
        ...
        foreach ($params as $key => $product_quantity) {
            ...
            $cart->addItem($product_id, $product_quantity['qty'], true);
    ...
    public function removeItemAction()
    {
        ...
        Socialcommerce_Api_Cart::getInstance()->removeCartItem($id);
