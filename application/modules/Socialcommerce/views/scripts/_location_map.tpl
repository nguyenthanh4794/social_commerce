...
<div id="ynbusinesspages_direction" class="ynbusinesspage-location-maps">
    ...
    array('route' => 'socialcommerce_general', 'action' => 'direction', 'lat' => $this->item->latitude, 'long' => $this->item->longitude, 'location' => $this->item->location),
    $this->translate('<i class="ynicon yn-location-arrow"></i> Get Direction'),
