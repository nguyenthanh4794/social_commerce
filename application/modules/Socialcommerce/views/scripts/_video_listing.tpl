<div class="video_thumb_wrapper video_thumb_wrapper">
    <?php if ($this->video->duration): ?>
        <?php echo $this->partial('_video_duration.tpl', 'socialcommerce', array('video' => $this->video)) ?>
    <?php endif ?>
    <?php
...
<?php
    echo $this->partial('_video_rating_big.tpl', 'socialcommerce', array('video' => $this->video));
?>