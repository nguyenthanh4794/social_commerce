<?php if (!$this->longitude || !$this->latitude) : ?>
...
<?php $this->headScript()->appendFile("https://maps.googleapis.com/maps/api/js?key=". Engine_Api::_() -> getApi('settings', 'core') -> getSetting('yncore.google.api.key', 'AIzaSyB3LowZcG12R1nclRd9NrwRgIxZNxLMjgc')."&v=3.exp&sensor=false&libraries=places"); ?>
<style>
    .controls {
...
<div id="socialcommerce_direction">
    <h4><?php echo $this->translate("Get Direction");?></h4>
    <div class="socialcommerce_widget_location_direction">
        ...
        <span class="close-btn" style="cursor: pointer" onclick="clearInputLocation()" id="socialcommerce_location_direction_close_btn">x</span>
    </div>
    <div class="socialcommerce_widget_location_direction get_current_position">
        <label for="starting_current_position">&nbsp;</label>
        <a href="javascript:void(0);" onclick="getCurrentPosition()" class="buttonlink location_icon"><?php echo $this->translate("Get current position");?></a>
    </div>
    ...
    <div class="socialcommerce_widget_location_direction socialcommerce_widget_location_direction_button">
        <label>&nbsp;</label>
...
<script>
    var fromPoint;
    var endPoint = new  google.maps.LatLng(<?php echo $this->latitude;?>, <?php echo $this->longitude;?>);
    ...
    function initialize() {
        var center =  new google.maps.LatLng(<?php echo $this->latitude;?>, <?php echo $this->longitude;?>);
        var mapOptions = {
            center: center,
            zoom: 13
        };
