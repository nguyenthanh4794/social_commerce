...
->prependStylesheet($staticBaseUrl . 'application/modules/Socialcommerce/externals/styles/upload_photo/jquery.fileupload.css');

$this->headScript()
->appendFile($staticBaseUrl . 'application/modules/Socialcommerce/externals/scripts/jquery-1.10.2.min.js')
->appendScript('jQuery.noConflict();')
->appendFile($staticBaseUrl . 'application/modules/Socialcommerce/externals/scripts/js/vendor/jquery.ui.widget.js')
->appendFile($staticBaseUrl . 'application/modules/Socialcommerce/externals/scripts/js/jquery.iframe-transport.js')
->appendFile($staticBaseUrl . 'application/modules/Socialcommerce/externals/scripts/js/jquery.fileupload.js')
...
<script>
    jQuery(function ()
    {
        ...
        var count = 0;
        var url = '<?php echo $this->url(array('module' => 'socialcommerce', 'controller' => 'photo', 'action' => 'upload-photo'), 'default')?>';
    ...
    {
        new Request.JSON({
            url: '<?php echo $this->url(array('module'=>'socialcommerce','controller'=>'photo','action'=>'delete-photo'), 'default') ?>',
            data: {
                'format': 'json',
                'photo_id': photo_id
            }
