    ...
    <div class='settings'>
        <form class="global_form">
            <div>
                ...
                <h3><?php echo $this->translate("Social Commerce Categories") ?></h3>
                <p><?php echo $this->translate("SOCIALCOMMERCE_ADMIN_CATEGORY_DESCRIPTION") ?></p>
                <br />
                <div>
                    <?php foreach($this->category->getBreadCrumNode() as $node): ?>
                    <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'socialcommerce', 'controller' => 'categories', 'action' => 'index', 'parent_id' =>$node->category_id), $this->translate($node->shortTitle()), array()) ?>
                    &raquo;
                    <?php endforeach; ?>
                    <strong><?php
                ...
                <table style="position: relative;" class='admin_table'>
                    ...
                    <tr id='category_item_<?php echo $category->getIdentity() ?>'>
                        ...
                        <td>
                            ...
                            <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'socialcommerce', 'controller' => 'categories', 'action' => 'edit-category', 'id' =>$category->category_id), $this->translate('edit'), array(
                            'class' => 'smoothbox',
                            )) ?>
                            |
                            ...
                            |
                            <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'socialcommerce', 'controller' => 'categories', 'action' => 'index', 'parent_id' =>$category->category_id), $this->translate('view sub-category'), array(
                            )) ?>
                            <?php endif;?>
                        </td>
                    </tr>
                ...
                <?php endif;?>
                <br/>
                <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'socialcommerce', 'controller' => 'categories', 'action' => 'add-category','parent_id'=>$this->category->getIdentity()), $this->translate('Add Category'), array(
