    ...
    <?php
    	if(count($this->paginator) > 0)
    	{
    		echo $this->htmlLink(array(
    	          ...
    	          'tab' => $this->identity,
    	        ), '<i class="ynicon yn-list-view"></i>'.$this->translate('View All Events'), array(
    	          'class' => 'buttonlink'
    	      ));
    	}
      ...
      if( $this->canAdd ): ?>
        <?php echo $this->htmlLink(array(
          ...
          ), '<i class="ynicon yn-plus-circle"></i>'.$this->translate('Add Event'), array(
            'class' => 'buttonlink'
        )) ?>
      <?php endif; ?>
  </div>
      ...
      <li class="ynbusinesspages_profile_event_item">
        <div class="photo">
          ...
          <div class="info">
            ...
            <div class="stats">
                <span class="person" title="<?php echo $this -> translate("Guests")?>"><?php echo $event->member_count; ?> <i class="ynicon yn-user"></i></span>
                <span class="view" title="<?php echo $this -> translate("Views")?>"><?php echo $event->view_count; ?> <i class="ynicon yn-eye"></i></span>
