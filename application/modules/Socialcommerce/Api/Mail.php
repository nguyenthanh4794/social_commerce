...
class Socialcommerce_Api_Mail extends Core_Api_Abstract
{
    /**
    ...
    public function getFromAddress()
    {
        ...
        if ($this->_fromAddress == NULL) {
            $this->_fromAddress = Engine_Api::_()->getApi('settings', 'core')->getSetting('core.mail.from', 'test1@local.gmail.com');
        }
    ...
    public function getTemplate($type, $locale = 'en')
    {
        ...
        $table = Engine_Api::_()->getDbtable('SocialTemplates', 'Socialcommerce');
    ...
    public function send($recipient, $type, $params, $use_mail_queue = false, $mail_priority = 0)
    {
        ...
        $mailTemplateTable = Engine_Api::_()->getDbtable('SocialTemplates', 'Socialcommerce');
        ...
        $vars = array();
        $params = Engine_Api::_()->getApi('ConvertMailVars', 'Socialcommerce')->process($params, $vars, $type);
